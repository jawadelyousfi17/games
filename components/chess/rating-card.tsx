...
export function RatingCard({ summary }: RatingCardProps) {
  return (
    <div className="rounded-2xl bg-navy-850 p-5 ring-1 ring-white/5">
      <div className="mb-1 font-mono text-[11px] uppercase tracking-wider text-navy-400">
        Rating
      </div>
      <div className="text-[36px] font-extrabold leading-none text-white">
        {summary.rating}
      </div>
      <div className="mt-3 flex items-center gap-4 font-mono text-[12px] text-navy-300">
